...
if db_node.lifecycle_state != "STOPPED":
    warning_beep(1)
    raise RuntimeWarning("WARNING! DB System is not in a STOPPED state.")

# Proceed with the shutdown
print("Starting DB System {} in compartment {} , please wait......\n".format(
    db_system_name,
    child_compartment_name
))
startup_request_results = start_stop_db_node(
