...
$ADMIN_PASSWORD             = "ADummyPassw0rd_#1"
#$DB_COMPARTMENT_OCID        = "ocid1.compartment.oc1..aaaaaaaaysl6m26pkjmwh4lpbx6y2bwdlpf6amfv2x5lrtkdcpiae66jfqbq"
$DB_COMPARTMENT_OCID        = "ocid1.compartment.oc1..aaaaaaaa73jwew63jl77pwvidvznkxnjyx5cg4yjphqq5b4dwt44j4cfex6a"
$DB_CONTAINER_NAME          = 'DWTCDB'
$DB_DISPLAY_NAME            = 'DWTCDB'
$DB_NODE_COUNT              = 1
$DB_DB_NAME                 = 'TEST'
$DB_DB_WORKLOAD             = 'OLTP'                    # May be DSS for warehouse or OLTP for transactional
$DB_PDB_NAME                = 'DWTEST'
$DB_VERSION                 = '19.6.0.0'
#$DB_SSH_KEY                 = "/home/ansible/.ssh/DBaaS_rsa.pub"
$DB_SSH_KEY                 = "/Users/henrywojteczko/.ssh/id_rsa.pub"
#$DB_SUBNET_OCID             = "ocid1.subnet.oc1.iad.aaaaaaaar4ceiattvjci4x5v7yezscnwgfykkrmriwfgzzpce5w5dr6zva7q"
$DB_SUBNET_OCID             = "ocid1.subnet.oc1.iad.aaaaaaaaqm3yc5h6hmmx5nvaepgo76jkuryfxrvvb2c64zh2naj5o4ga4lcq"
$DB_SYSTEM_CPU_CORE_COUNT   = 1
