...
if len(sys.argv) != 20: # ARGS PLUS COMMAND
...
DB_DB_NAME                  = sys.argv[6]
DB_DB_WORKLOAD              = sys.argv[7]
DB_DISPLAY_NAME             = sys.argv[8]
DB_NODE_COUNT               = int(sys.argv[9])
DB_PDB_NAME                 = sys.argv[10]
DB_VERSION                  = sys.argv[11]
DB_SYSTEM_CPU_CORE_COUNT    = int(sys.argv[12])
DB_SYSTEM_NAME              = sys.argv[13]
DB_SYSTEM_STORAGE_GB        = int(sys.argv[14])
DB_SYSTEM_DB_EDITION        = sys.argv[15]
DB_SYSTEM_SHAPE             = sys.argv[16]
DB_SYSTEM_STORAGE_MGMT      = sys.argv[17]
DB_SUBNET_OCID              = sys.argv[18]
DB_TIME_ZONE                = sys.argv[19]
'''
...
try:
    ...
    #print(launch_db_system_details)
    #exit(0)
