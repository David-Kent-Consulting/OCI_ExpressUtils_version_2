...
#ansible-playbook 1000_StartBannerTestServices.yaml # start all services

# initiate disk snap replication to DR region
ansible-playbook 1000_ReplicateVmDiskSnaps.yaml # replicate all disk snaps