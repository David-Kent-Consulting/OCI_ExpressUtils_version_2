...
$SecLists       = oci network 'security-list' list `
...
#$SecLists.data
if (!$SecLists) {
  Write-Output "No security lists found in compartment $CompartmentName for VCN $VcnName. Please try again."
  return 1}

$return         = SelectSecList $SecurityListName $SecLists
